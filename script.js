...
//     guesser.addEventListener("click" , press);
//     function press(){
//         if(guesser.value == guesserTarget) alert("Y");
//     }
// })
...
// let guesser = document.querySelector("#guesser").forEach(guesser=>{
//     guesser.addEventListener("click" , getValue);
//     function getValue(){
//         if(+guesser.value === +guesserTarget) return true;
//     }
// })
